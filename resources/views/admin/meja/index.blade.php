            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary" id="btn-Tambah-meja" data-toggle="modal" data-target="#exampleModalCenter">
                                    ...
                                    @foreach($datameja as $meja)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <button class="btn btn-sm btn-warning mr-2 edit-meja" data-toggle="modal" data-target="#exampleModalCenter">Edit</button>
