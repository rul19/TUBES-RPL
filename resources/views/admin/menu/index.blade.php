            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button class="btn btn-primary" id="btn-Tambah-menu" data-toggle="modal" data-target="#exampleModalCenter">
                                    ...
                                    @foreach($datamenu as $menu)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-center">
                                                <button class="btn btn-sm btn-warning mr-2 edit-menu" data-toggle="modal" data-target="#exampleModalCenter">Edit</button>
                                                <form class="hapus-menu" dt-id="{{ $menu->id }}" dt-nama="{{ $menu->nama_menu }}" method="POST" action="{{ route('menu.delete', $menu->id) }}">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <!-- Form Tambah Menu -->
                <form action="/admin/tambah_menu" method="POST" enctype="multipart/form-data" id="form_tambah_menu" style="display: none;">
                    @csrf
                ...
                <form method="POST" enctype="multipart/form-data" id="form_edit_menu" style="display: none;">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="nama_menu_up">Nama Menu</label>
                            <input type="text" class="form-control" name="nama_menu" id="nama_menu_up" placeholder="Masukkan nama menu..">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="kategori_up">Kategori</label>
                        ...
                        <div class="form-group">
                            <label for="foto_menu_up">Foto Menu</label>
