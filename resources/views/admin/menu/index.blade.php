                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <img src="{{ asset('storage/' . $menu->foto) }}" style="width:150px; height:100px;" alt="{{ $menu->nama_menu }}">
                        </td>
                        <td>{{ $menu->nama_menu }}</td>
                        <td>Rp {{ $menu->harga }}</td>
                        <td>{{ $menu->kategori->nama_kategori }}</td>
                        <td class="d-flex justify-content-center">
                          <button class="btn btn-sm btn-warning edit-menu mr-2" data-toggle="modal" data-target="#exampleModalCenter">Edit</button>
